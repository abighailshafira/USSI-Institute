        ...
        <div className="container">
          <div className="w-full px-4">
            <div className="mx-auto text-center mb-10">
              ...
              <h2 className="text-base text-slate-500">Kami siap membantu anda untuk lebih bersinergi</h2>
            </div>
          </div>
          ...
          <Slider {...settings}>
            <div className="px-5 py-5">
              <div className="bg-white rounded-md shadow-lg">
                ...
                <div className="text-center pb-5">
                  <h5 className="text-lg font-bold text-slate-800">Rukanda Tahyana</h5>
                  <p className="text-base text-slate-400">Direktur Utama PT. USSI PPS</p>

                  <div class="flex justify-center space-x-3 text-cyan-500 mt-7">
            ...
            <div className="px-5 py-5">
              <div className="bg-white rounded-md shadow-lg">
                ...
                <div className="text-center pb-5">
                  <h5 className="text-lg font-bold text-slate-800">Dede Hendrawan P.</h5>
                  <p className="text-base text-slate-400">Manager USSI Institute</p>
            ...
            <div className="px-5 py-5">
              <div className="bg-white rounded-md shadow-lg">
                ...
                <div className="text-center pb-5">
                  <h5 className="text-lg font-bold text-slate-800">Naufal Azhfar Zaid</h5>
                  <p className="text-base text-slate-400">Staff USSI Institute</p>
            ...
            <div className="px-5 py-5">
              <div className="bg-white rounded-md shadow-lg">
                ...
                <div className="text-center pb-5">
                  <h5 className="text-lg font-bold text-slate-800">Firli Arwandi</h5>
                  <p className="text-base text-slate-400">Staff USSI Institute</p>
