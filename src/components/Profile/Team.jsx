    ...
    const data = [
      {
        id: 1,
        img: Image1,
        name: "Rukanda Tahyana",
        position: "Direktur Utama PT. USSI PPS",
      },
      {
        id: 2,
        img: Image2,
        name: "Dede Hendrawan P.",
        position: "Manager USSI Institute",
      },
      {
        id: 3,
        img: Image3,
        name: "Naufal Azhfar Zaid",
        position: "Staff USSI Institute",
      },
      {
        id: 4,
        img: Image3,
              ...
              <div className="px-3 py-5">
                <div className="bg-white rounded-md shadow-lg">
                  ...
                  <div className="text-center pb-5">
                    ...
                    <p className="text-sm text-slate-400">{data.position}</p>
