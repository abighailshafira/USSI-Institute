      ...
      <footer>
        ...
        <div class="bg-slate-800">
          <div class="container text-white text-center md:text-left">
              ...
              <div class="w-full mb-6 md:w-1/2 lg:w-1/4">
                <div class="flex justify-center md:justify-start lg:justify-end">
                  <a
                    href="#"
                    target="_blank"
                    class="w-9 h-9 mr-3 text-slate-30 flex justify-center"
                  >
                    <svg
                      role="img"
                      width="30"
            ...
            <div class="w-full border-t border-slate-700 text-center p-6">
              <span class="text-slate-500 text-xs font-medium py-5">
                Copyright © 2022{" "}
