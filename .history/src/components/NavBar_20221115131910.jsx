        ...
        <div className="flex items-center justify-between h-16 relative">
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-4">
              <Link to="/">
                <a className="pilih hover:text-cyan-500 px-3 py-2 text-base text-black">Beranda</a>
              </Link>

              <Link to="/profile">
                <a className="pilih hover:text-cyan-500 px-3 py-2 text-base text-black">Tentang</a>
              </Link>
