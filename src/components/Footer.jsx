          ...
          <div className="container text-white text-center md:text-left">
            <div className="flex flex-wrap justify-center pt-10 ">
              ...
              <div className="w-full mb-6 md:w-1/2 lg:w-1/4">
                ...
                <p className="mb-4">
                  <Link to="/">
                    <a className="text-white hover:text-cyan-500">Beranda</a>
                  </Link>
                </p>
                ...
                <p className="mb-4">
                  <Link to="/jadwal-pelatihan">
                    <a className="text-white hover:text-cyan-500">Pelatihan</a>
                  </Link>
                </p>
              ...
              <div className="w-full mb-6 md:w-1/2 lg:w-1/4">
                <div className="flex justify-center md:justify-start lg:justify-end">
                  <a href="https://api.whatsapp.com/send/?phone=628119018005&text&app_absent=0" target="_blank" className="w-9 h-9 mr-3 text-slate-30 flex justify-center text-white hover:text-cyan-500">
                  ...
                  <a href="https://www.facebook.com/ussisoftwareonline/" target="_blank" className="w-9 h-9 mr-3 text-slate-30 flex justify-center text-white hover:text-cyan-500">
                    <svg role="img" width="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                  ...
                  <a href="https://www.instagram.com/ussicorp/" target="_blank" className="w-9 h-9 mr-3 text-slate-30 flex justify-center text-white hover:text-cyan-500">
                    <svg role="img" width="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="fill-current">
