...
const DetailPelatihan = () => {
  return (
    <>
      <section id="detail-pelatihan" class="pt-36">
        <div class="container">
          <div class="flex flex-wrap justify-center">
            <div class="w-full px-4 mb-10 md:w-1/2">
              <div>
                <h1 class="text-4xl font-bold mb-10 text-slate-800 flex items-center ">
              ...
              <p class="text-slate-500 py-2 flex items-center">
              ...
              <div>
                <h2 class="text-2xl font-semibold text-slate-800 mt-5 py-6">Ready to Participate?</h2>
                <a href="#" class="text-sm font-semibold text-white bg-cyan-500 py-3 px-8 rounded-md">
                  Daftar Sekarang
                </a>
              </div>
            </div>
            <div class="w-full px-4 md:w-1/2">
              <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2 ">
                  <img src="https://source.unsplash.com/360x200?programming" alt="Pelatihan" class="w-full rounded-lg" />
                </div>
                <div class=" ">
                  <img src="https://source.unsplash.com/360x200?programming" alt="Pelatihan" class="w-full rounded-lg" />
                </div>
