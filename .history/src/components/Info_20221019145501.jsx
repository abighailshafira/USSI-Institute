        ...
        <div className="w-full px-4">
          <div className="flex flex-wrap justify-center items-center">
            <div className="w-full px-4 md:w-1/2 lg:w-1/3 xl:w-1/4">
              <div className="">
                <img src="./dist/img/staff.png" alt="" width="120px" className="mx-auto" />
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3 xl:w-1/4">
              <div className="">
                <img src="./dist/img/staff2.png" alt="" width="120px" className="mx-auto" />
                <div className="text-center">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3 xl:w-1/4">
              <div className="">
                <img src="./dist/img/done.png" alt="" width="120px" className="mx-auto" />
                <div className="text-center">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3 xl:w-1/4">
              <div className="">
                <img src="./dist/img/ongoing.png" alt="" width="120px" className="mx-auto" />
                <div className="text-center">
