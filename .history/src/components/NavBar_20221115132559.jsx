            ...
            <div className="flex items-center space-x-4">
              ...
              <Menu as="div" className="relative">
                <Menu.Button className="pilih inline-flex items-center hover:text-cyan-500 px-3 py-2 text-base text-white ">
                  Pelatihan
                  <RiArrowDownSLine className="ml-2 text-white" aria-hidden="true" />
                </Menu.Button>
                ...
                >
                  <Menu.Items className="absolute right-0 mt-6 w-52 origin-top-right rounded-md bg-white shadow-lg p-2">
                    {links.map((link) => (
                      <Menu.Item as="a" key={link.href} href={link.href} className="pilih text-black flex w-full items-center px-4 py-2 text-base hover:bg-slate-700 hover:text-white rounded-md">
                        {link.label}
                      </Menu.Item>
                    ))}
                  </Menu.Items>
